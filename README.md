Module: Information Theory (infotheory)
===============================================================================

This is a learning module for Information Theory.  It's aim is to give the 
students an introduction to the basics of information theory and some 
...
- `basics` contains slides for an introductory lecture on information theory 
  and its uses in security.
